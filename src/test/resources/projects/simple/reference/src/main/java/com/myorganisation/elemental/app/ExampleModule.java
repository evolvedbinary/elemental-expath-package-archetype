package com.myorganisation.elemental.app;
...
public class ExampleModule extends AbstractInternalModule {
    ...
    public static final String NAMESPACE_URI = "https://my-organisation.com/elemental/ns/app/my-java-module";
    public static final String PREFIX = "myjmod";
    public static final String RELEASED_IN_VERSION = "Elemental-6.4.0";
    ...
    public String getDescription() {
        return "Example Module for Elemental XQuery";
    }
